...
// Custom button code mapping (Prog/UP swap Key_1 <-> Prog, like alutech patterns)
...
static bool
    ...
    // Save original button and apply custom button remap
 ...
 */
    ...
    // Save original button for custom button feature
    if(subghz_custom_btn_get_original() == 0) {
