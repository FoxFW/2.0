...
static UpdaterApp* s_connect_settings_app = NULL;
...
static void connect_settings_draw_cb(Canvas* canvas, void* model) {
    UNUSED(model);
    UpdaterApp* app = s_connect_settings_app;
    if(app == NULL) return;
...
static void connect_settings_cycle_pin(UpdaterApp* app, int delta) {
...
static void connect_settings_cycle_baud(UpdaterApp* app, int delta) {
