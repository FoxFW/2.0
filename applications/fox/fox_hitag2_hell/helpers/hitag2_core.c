...
// Independent byte-array-state reference implementation, transcribed from
// fiat_v1_bcm_generate_authenticator() in lib/subghz/protocols/fiat_v1.c.
// Kept private to the self-test so it stays a genuine cross-check against
// the packed-u64 implementation above, without depending on core-subghz
// internals (not exported for external apps).
